...
public enum BibleBooks{
	...
	/**
	 * Constructs a {@link BibleBooks} with the given book name, author, and
	 ...
	 */
	BibleBooks(String name, String author, List<Integer> chapters){
		this.name = name;
		this.author = author;
	...
	/**
	 * Constructs a {@link BibleBooks} with the given book name, author, aliases,
	 ...
	 * @param chapters The number of verses in each chapter of this book
	 */
	BibleBooks(String name, String author, List<String> aliases, List<Integer> chapters){
		this.name = name;
		this.author = author;
	...
	/**
	 * Find a {@link BibleBooks} object based on the book name.
	 * 
	 * @param bookName The book name to find
	 * @return The found {@link BibleBooks}, or null if none could be found
	 */
	public static BibleBooks fromName(String bookName){
		// Search through the existing BibleBooks for the book name
	...
	/**
	 * Find a {@link BibleBooks} object based on text that may be the book name or an alias.
	 * 
	 * @param text The text to find
	 * @return The found {@link BibleBooks}, or null if none could be found
	 */
	public static BibleBooks fromString(String text){
		// Search through the existing BibleBooks for the text
		for(BibleBooks book: BibleBooks.values()){
	...
	/**
	 * Find a {@link BibleBooks} object based on the book number.
	 * 
	 * @param bookNum The book number of the book to grab
	 * @return The found {@link BibleBooks}, or null if it's an invalid book number
	 */
	public static BibleBooks fromInt(int bookNum){
		// Check that bookNum is between 1 and 66
		if(bookNum > 0 && bookNum < 67){
			// Return the BibleBooks book corresponding to the given book number
			return BibleBooks.values()[bookNum-1];
		}else{
