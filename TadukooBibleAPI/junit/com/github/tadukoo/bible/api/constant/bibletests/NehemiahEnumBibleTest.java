...
import static com.github.tadukoo.bible.api.constant.EnumBible.NEHEMIAH;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class NehemiahEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(NEHEMIAH, EnumBible.fromName("Nehemiah"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(NEHEMIAH, EnumBible.fromString("Nehemiah"));
	}
	
	@Test
	public void testFromAliasNeh(){
		assertEquals(NEHEMIAH, EnumBible.fromString("Neh"));
	}
	
	@Test
	public void testFromAliasNe(){
		assertEquals(NEHEMIAH, EnumBible.fromString("Ne"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(NEHEMIAH, EnumBible.fromInt(16));
	}
}
