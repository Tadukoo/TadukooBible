...
import static com.github.tadukoo.bible.api.constant.BibleBooks.HEBREWS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class HebrewsBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(HEBREWS, BibleBooks.fromName("Hebrews"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(HEBREWS, BibleBooks.fromString("Hebrews"));
	}
	
	@Test
	public void testFromAliasHeb(){
		assertEquals(HEBREWS, BibleBooks.fromString("Heb"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(HEBREWS, BibleBooks.fromInt(58));
	}
}
