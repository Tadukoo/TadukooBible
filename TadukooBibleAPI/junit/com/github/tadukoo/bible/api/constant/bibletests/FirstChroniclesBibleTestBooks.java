...
import static com.github.tadukoo.bible.api.constant.BibleBooks.FIRST_CHRONICLES;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class FirstChroniclesBibleTestBooks{
	...
	public void testFromName(){
		assertEquals(FIRST_CHRONICLES, BibleBooks.fromName("1 Chronicles"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(FIRST_CHRONICLES, BibleBooks.fromString("1 Chronicles"));
	}
	
	@Test
	public void testFromAlias1Chron(){
		assertEquals(FIRST_CHRONICLES, BibleBooks.fromString("1Chron"));
	}
	
	@Test
	public void testFromAlias1Ch(){
		assertEquals(FIRST_CHRONICLES, BibleBooks.fromString("1Ch"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(FIRST_CHRONICLES, BibleBooks.fromInt(13));
	}
}
