...
import static com.github.tadukoo.bible.api.constant.BibleBooks.FIRST_TIMOTHY;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class FirstTimothyBibleTestBooks{
	...
	public void testFromName(){
		assertEquals(FIRST_TIMOTHY, BibleBooks.fromName("1 Timothy"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(FIRST_TIMOTHY, BibleBooks.fromString("1 Timothy"));
	}
	
	@Test
	public void testFromAlias1Tim(){
		assertEquals(FIRST_TIMOTHY, BibleBooks.fromString("1Tim"));
	}
	
	@Test
	public void testFromAlias1Ti(){
		assertEquals(FIRST_TIMOTHY, BibleBooks.fromString("1Ti"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(FIRST_TIMOTHY, BibleBooks.fromInt(54));
	}
}
