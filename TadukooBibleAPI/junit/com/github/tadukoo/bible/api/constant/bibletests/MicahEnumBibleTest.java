...
public class MicahEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(MICAH, EnumBible.fromName("Micah"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(MICAH, EnumBible.fromString("Micah"));
	}
	
	@Test
	public void testFromAliasMic(){
		assertEquals(MICAH, EnumBible.fromString("Mic"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(MICAH, EnumBible.fromInt(33));
	}
}
