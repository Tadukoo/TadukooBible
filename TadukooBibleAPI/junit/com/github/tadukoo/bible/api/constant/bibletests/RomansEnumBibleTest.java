...
import static com.github.tadukoo.bible.api.constant.EnumBible.ROMANS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class RomansEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(ROMANS, EnumBible.fromName("Romans"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(ROMANS, EnumBible.fromString("Romans"));
	}
	
	@Test
	public void testFromAliasRom(){
		assertEquals(ROMANS, EnumBible.fromString("Rom"));
	}
	
	@Test
	public void testFromAliasRo(){
		assertEquals(ROMANS, EnumBible.fromString("Ro"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(ROMANS, EnumBible.fromInt(45));
	}
}
