...
import static com.github.tadukoo.bible.api.constant.EnumBible.MATTHEW;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class MatthewEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(MATTHEW, EnumBible.fromName("Matthew"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(MATTHEW, EnumBible.fromString("Matthew"));
	}
	
	@Test
	public void testFromAliasMat(){
		assertEquals(MATTHEW, EnumBible.fromString("Mat"));
	}
	
	@Test
	public void testFromAliasMt(){
		assertEquals(MATTHEW, EnumBible.fromString("Mt"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(MATTHEW, EnumBible.fromInt(40));
	}
}
