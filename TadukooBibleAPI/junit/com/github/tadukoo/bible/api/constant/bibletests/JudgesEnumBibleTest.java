...
public class JudgesEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(JUDGES, EnumBible.fromName("Judges"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(JUDGES, EnumBible.fromString("Judges"));
	}
	
	@Test
	public void testFromAliasJud(){
		assertEquals(JUDGES, EnumBible.fromString("Jud"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(JUDGES, EnumBible.fromInt(7));
	}
}
