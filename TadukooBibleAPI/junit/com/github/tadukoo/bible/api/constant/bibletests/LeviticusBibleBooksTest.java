...
import static com.github.tadukoo.bible.api.constant.BibleBooks.LEVITICUS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class LeviticusBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(LEVITICUS, BibleBooks.fromName("Leviticus"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(LEVITICUS, BibleBooks.fromString("Leviticus"));
	}
	
	@Test
	public void testFromAliasLev(){
		assertEquals(LEVITICUS, BibleBooks.fromString("Lev"));
	}
	
	@Test
	public void testFromAliasLe(){
		assertEquals(LEVITICUS, BibleBooks.fromString("Le"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(LEVITICUS, BibleBooks.fromInt(3));
	}
}
