...
import static com.github.tadukoo.bible.api.constant.EnumBible.PSALMS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class PsalmsEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(PSALMS, EnumBible.fromName("Psalms"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(PSALMS, EnumBible.fromString("Psalms"));
	}
	
	@Test
	public void testFromAliasPsalm(){
		assertEquals(PSALMS, EnumBible.fromString("Psalm"));
	}
	
	@Test
	public void testFromAliasPsa(){
		assertEquals(PSALMS, EnumBible.fromString("Psa"));
	}
	
	@Test
	public void testFromAliasPs(){
		assertEquals(PSALMS, EnumBible.fromString("Ps"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(PSALMS, EnumBible.fromInt(19));
	}
}
