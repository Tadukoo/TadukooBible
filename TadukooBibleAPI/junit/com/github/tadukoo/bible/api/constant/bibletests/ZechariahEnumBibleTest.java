...
public class ZechariahEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(ZECHARIAH, EnumBible.fromName("Zechariah"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(ZECHARIAH, EnumBible.fromString("Zechariah"));
	}
	
	@Test
	public void testFromAliasZec(){
		assertEquals(ZECHARIAH, EnumBible.fromString("Zec"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(ZECHARIAH, EnumBible.fromInt(38));
	}
}
