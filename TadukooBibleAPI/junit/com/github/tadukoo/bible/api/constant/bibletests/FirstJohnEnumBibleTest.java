...
import static com.github.tadukoo.bible.api.constant.EnumBible.FIRST_JOHN;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class FirstJohnEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(FIRST_JOHN, EnumBible.fromName("1 John"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(FIRST_JOHN, EnumBible.fromString("1 John"));
	}
	
	@Test
	public void testFromAlias1Jo(){
		assertEquals(FIRST_JOHN, EnumBible.fromString("1Jo"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(FIRST_JOHN, EnumBible.fromInt(62));
	}
}
