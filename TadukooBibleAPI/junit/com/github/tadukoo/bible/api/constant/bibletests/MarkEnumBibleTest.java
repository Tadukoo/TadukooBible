...
public class MarkEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(MARK, EnumBible.fromName("Mark"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(MARK, EnumBible.fromString("Mark"));
	}
	
	@Test
	public void testFromAliasMr(){
		assertEquals(MARK, EnumBible.fromString("Mr"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(MARK, EnumBible.fromInt(41));
	}
}
