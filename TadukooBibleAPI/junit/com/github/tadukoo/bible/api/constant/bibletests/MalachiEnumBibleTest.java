...
import static com.github.tadukoo.bible.api.constant.EnumBible.MALACHI;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class MalachiEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(MALACHI, EnumBible.fromName("Malachi"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(MALACHI, EnumBible.fromString("Malachi"));
	}
	
	@Test
	public void testFromAliasMal(){
		assertEquals(MALACHI, EnumBible.fromString("Mal"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(MALACHI, EnumBible.fromInt(39));
	}
}
