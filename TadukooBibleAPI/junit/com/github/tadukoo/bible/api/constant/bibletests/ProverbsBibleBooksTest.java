...
import static com.github.tadukoo.bible.api.constant.BibleBooks.PROVERBS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class ProverbsBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(PROVERBS, BibleBooks.fromName("Proverbs"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(PROVERBS, BibleBooks.fromString("Proverbs"));
	}
	
	@Test
	public void testFromAliasPro(){
		assertEquals(PROVERBS, BibleBooks.fromString("Pro"));
	}
	
	@Test
	public void testFromAliasPr(){
		assertEquals(PROVERBS, BibleBooks.fromString("Pr"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(PROVERBS, BibleBooks.fromInt(20));
	}
}
