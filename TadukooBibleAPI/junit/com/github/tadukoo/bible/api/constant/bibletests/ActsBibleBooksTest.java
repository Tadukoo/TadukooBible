...
import static com.github.tadukoo.bible.api.constant.BibleBooks.ACTS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class ActsBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(ACTS, BibleBooks.fromName("Acts"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(ACTS, BibleBooks.fromString("Acts"));
	}
	
	@Test
	public void testFromAliasAc(){
		assertEquals(ACTS, BibleBooks.fromString("Ac"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(ACTS, BibleBooks.fromInt(44));
	}
}
