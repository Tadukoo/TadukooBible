...
import static com.github.tadukoo.bible.api.constant.EnumBible.JOB;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class JobEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(JOB, EnumBible.fromName("Job"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(JOB, EnumBible.fromString("Job"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(JOB, EnumBible.fromInt(18));
	}
}
