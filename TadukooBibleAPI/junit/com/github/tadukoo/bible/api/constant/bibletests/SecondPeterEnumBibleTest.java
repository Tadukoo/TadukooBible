...
public class SecondPeterEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(SECOND_PETER, EnumBible.fromName("2 Peter"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(SECOND_PETER, EnumBible.fromString("2 Peter"));
	}
	
	@Test
	public void testFromAlias2Pe(){
		assertEquals(SECOND_PETER, EnumBible.fromString("2Pe"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(SECOND_PETER, EnumBible.fromInt(61));
	}
}
