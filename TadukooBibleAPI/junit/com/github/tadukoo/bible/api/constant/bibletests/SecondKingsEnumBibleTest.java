...
import static com.github.tadukoo.bible.api.constant.EnumBible.SECOND_KINGS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class SecondKingsEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(SECOND_KINGS, EnumBible.fromName("2 Kings"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(SECOND_KINGS, EnumBible.fromString("2 Kings"));
	}
	
	@Test
	public void testFromAlias2Ki(){
		assertEquals(SECOND_KINGS, EnumBible.fromString("2Ki"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(SECOND_KINGS, EnumBible.fromInt(12));
	}
}
