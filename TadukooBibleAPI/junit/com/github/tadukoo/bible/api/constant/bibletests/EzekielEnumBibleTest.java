...
import static com.github.tadukoo.bible.api.constant.EnumBible.EZEKIEL;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class EzekielEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(EZEKIEL, EnumBible.fromName("Ezekiel"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(EZEKIEL, EnumBible.fromString("Ezekiel"));
	}
	
	@Test
	public void testFromAliasEze(){
		assertEquals(EZEKIEL, EnumBible.fromString("Eze"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(EZEKIEL, EnumBible.fromInt(26));
	}
}
