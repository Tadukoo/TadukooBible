...
import static com.github.tadukoo.bible.api.constant.BibleBooks.SECOND_SAMUEL;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class SecondSamuelBibleTestBooks{
	...
	public void testFromName(){
		assertEquals(SECOND_SAMUEL, BibleBooks.fromName("2 Samuel"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(SECOND_SAMUEL, BibleBooks.fromString("2 Samuel"));
	}
	
	@Test
	public void testFromAlias2Sam(){
		assertEquals(SECOND_SAMUEL, BibleBooks.fromString("2Sam"));
	}
	
	@Test
	public void testFromAlias2Sa(){
		assertEquals(SECOND_SAMUEL, BibleBooks.fromString("2Sa"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(SECOND_SAMUEL, BibleBooks.fromInt(10));
	}
}
