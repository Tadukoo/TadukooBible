...
import static com.github.tadukoo.bible.api.constant.BibleBooks.EXODUS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class ExodusBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(EXODUS, BibleBooks.fromName("Exodus"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(EXODUS, BibleBooks.fromString("Exodus"));
	}
	
	@Test
	public void testFromAliasExo(){
		assertEquals(EXODUS, BibleBooks.fromString("Exo"));
	}
	
	@Test
	public void testFromAliasEx(){
		assertEquals(EXODUS, BibleBooks.fromString("Ex"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(EXODUS, BibleBooks.fromInt(2));
	}
}
