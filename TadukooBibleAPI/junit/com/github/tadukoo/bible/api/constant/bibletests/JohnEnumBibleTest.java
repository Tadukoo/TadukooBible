...
public class JohnEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(JOHN, EnumBible.fromName("John"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(JOHN, EnumBible.fromString("John"));
	}
	
	@Test
	public void testFromAliasJoh(){
		assertEquals(JOHN, EnumBible.fromString("Joh"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(JOHN, EnumBible.fromInt(43));
	}
}
