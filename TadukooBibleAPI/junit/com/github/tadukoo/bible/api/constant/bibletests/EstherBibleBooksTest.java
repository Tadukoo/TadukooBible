...
import static com.github.tadukoo.bible.api.constant.BibleBooks.ESTHER;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class EstherBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(ESTHER, BibleBooks.fromName("Esther"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(ESTHER, BibleBooks.fromString("Esther"));
	}
	
	@Test
	public void testFromAliasEst(){
		assertEquals(ESTHER, BibleBooks.fromString("Est"));
	}
	
	@Test
	public void testFromAliasEs(){
		assertEquals(ESTHER, BibleBooks.fromString("Es"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(ESTHER, BibleBooks.fromInt(17));
	}
}
