...
import static com.github.tadukoo.bible.api.constant.BibleBooks.LUKE;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class LukeBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(LUKE, BibleBooks.fromName("Luke"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(LUKE, BibleBooks.fromString("Luke"));
	}
	
	@Test
	public void testFromAliasLu(){
		assertEquals(LUKE, BibleBooks.fromString("Lu"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(LUKE, BibleBooks.fromInt(42));
	}
}
