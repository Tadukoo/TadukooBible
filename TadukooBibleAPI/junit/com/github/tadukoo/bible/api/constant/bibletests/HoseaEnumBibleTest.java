...
public class HoseaEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(HOSEA, EnumBible.fromName("Hosea"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(HOSEA, EnumBible.fromString("Hosea"));
	}
	
	@Test
	public void testFromAliasHos(){
		assertEquals(HOSEA, EnumBible.fromString("Hos"));
	}
	
	@Test
	public void testFromAliasHo(){
		assertEquals(HOSEA, EnumBible.fromString("Ho"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(HOSEA, EnumBible.fromInt(28));
	}
}
