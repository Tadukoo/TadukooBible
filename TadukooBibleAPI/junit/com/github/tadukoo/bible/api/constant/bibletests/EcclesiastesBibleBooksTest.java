...
import static com.github.tadukoo.bible.api.constant.BibleBooks.ECCLESIASTES;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class EcclesiastesBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(ECCLESIASTES, BibleBooks.fromName("Ecclesiastes"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(ECCLESIASTES, BibleBooks.fromString("Ecclesiastes"));
	}
	
	@Test
	public void testFromAliasEcc(){
		assertEquals(ECCLESIASTES, BibleBooks.fromString("Ecc"));
	}
	
	@Test
	public void testFromAliasEc(){
		assertEquals(ECCLESIASTES, BibleBooks.fromString("Ec"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(ECCLESIASTES, BibleBooks.fromInt(21));
	}
}
