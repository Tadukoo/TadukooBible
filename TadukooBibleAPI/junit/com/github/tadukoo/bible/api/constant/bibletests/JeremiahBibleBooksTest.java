...
import static com.github.tadukoo.bible.api.constant.BibleBooks.JEREMIAH;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class JeremiahBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(JEREMIAH, BibleBooks.fromName("Jeremiah"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(JEREMIAH, BibleBooks.fromString("Jeremiah"));
	}
	
	@Test
	public void testFromAliasJer(){
		assertEquals(JEREMIAH, BibleBooks.fromString("Jer"));
	}
	
	@Test
	public void testFromAliasJe(){
		assertEquals(JEREMIAH, BibleBooks.fromString("Je"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(JEREMIAH, BibleBooks.fromInt(24));
	}
}
