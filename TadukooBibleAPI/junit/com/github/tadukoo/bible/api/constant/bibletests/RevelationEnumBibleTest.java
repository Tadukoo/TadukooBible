...
public class RevelationEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(REVELATION, EnumBible.fromName("Revelation"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(REVELATION, EnumBible.fromString("Revelation"));
	}
	
	@Test
	public void testFromAliasRev(){
		assertEquals(REVELATION, EnumBible.fromString("Rev"));
	}
	
	@Test
	public void testFromAliasRe(){
		assertEquals(REVELATION, EnumBible.fromString("Re"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(REVELATION, EnumBible.fromInt(66));
	}
}
