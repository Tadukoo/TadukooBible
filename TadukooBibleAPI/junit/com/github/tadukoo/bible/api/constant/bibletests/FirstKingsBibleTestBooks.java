...
import static com.github.tadukoo.bible.api.constant.BibleBooks.FIRST_KINGS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class FirstKingsBibleTestBooks{
	...
	public void testFromName(){
		assertEquals(FIRST_KINGS, BibleBooks.fromName("1 Kings"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(FIRST_KINGS, BibleBooks.fromString("1 Kings"));
	}
	
	@Test
	public void testFromAlias1Ki(){
		assertEquals(FIRST_KINGS, BibleBooks.fromString("1Ki"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(FIRST_KINGS, BibleBooks.fromInt(11));
	}
}
