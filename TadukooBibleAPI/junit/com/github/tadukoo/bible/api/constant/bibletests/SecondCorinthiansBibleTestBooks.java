...
import static com.github.tadukoo.bible.api.constant.BibleBooks.SECOND_CORINTHIANS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class SecondCorinthiansBibleTestBooks{
	...
	public void testFromName(){
		assertEquals(SECOND_CORINTHIANS, BibleBooks.fromName("2 Corinthians"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(SECOND_CORINTHIANS, BibleBooks.fromString("2 Corinthians"));
	}
	
	@Test
	public void testFromAlias2Cor(){
		assertEquals(SECOND_CORINTHIANS, BibleBooks.fromString("2Cor"));
	}
	
	@Test
	public void testFromAlias2Co(){
		assertEquals(SECOND_CORINTHIANS, BibleBooks.fromString("2Co"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(SECOND_CORINTHIANS, BibleBooks.fromInt(47));
	}
}
