...
import static com.github.tadukoo.bible.api.constant.EnumBible.SECOND_CHRONICLES;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class SecondChroniclesEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(SECOND_CHRONICLES, EnumBible.fromName("2 Chronicles"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(SECOND_CHRONICLES, EnumBible.fromString("2 Chronicles"));
	}
	
	@Test
	public void testFromAlias2Chron(){
		assertEquals(SECOND_CHRONICLES, EnumBible.fromString("2Chron"));
	}
	
	@Test
	public void testFromAlias2Ch(){
		assertEquals(SECOND_CHRONICLES, EnumBible.fromString("2Ch"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(SECOND_CHRONICLES, EnumBible.fromInt(14));
	}
}
