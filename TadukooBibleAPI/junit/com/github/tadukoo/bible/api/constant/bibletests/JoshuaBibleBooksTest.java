...
import static com.github.tadukoo.bible.api.constant.BibleBooks.JOSHUA;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class JoshuaBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(JOSHUA, BibleBooks.fromName("Joshua"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(JOSHUA, BibleBooks.fromString("Joshua"));
	}
	
	@Test
	public void testFromAliasJos(){
		assertEquals(JOSHUA, BibleBooks.fromString("Jos"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(JOSHUA, BibleBooks.fromInt(6));
	}
}
