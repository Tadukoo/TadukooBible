...
import static com.github.tadukoo.bible.api.constant.EnumBible.FIRST_THESSALONIANS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class FirstThessaloniansEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(FIRST_THESSALONIANS, EnumBible.fromName("1 Thessalonians"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(FIRST_THESSALONIANS, EnumBible.fromString("1 Thessalonians"));
	}
	
	@Test
	public void testFromAlias1Thes(){
		assertEquals(FIRST_THESSALONIANS, EnumBible.fromString("1Thes"));
	}
	
	@Test
	public void testFromAlias1Th(){
		assertEquals(FIRST_THESSALONIANS, EnumBible.fromString("1Th"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(FIRST_THESSALONIANS, EnumBible.fromInt(52));
	}
}
