...
public class EphesiansEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(EPHESIANS, EnumBible.fromName("Ephesians"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(EPHESIANS, EnumBible.fromString("Ephesians"));
	}
	
	@Test
	public void testFromAliasEph(){
		assertEquals(EPHESIANS, EnumBible.fromString("Eph"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(EPHESIANS, EnumBible.fromInt(49));
	}
}
