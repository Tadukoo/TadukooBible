...
public class SongofSongsEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(SONG_OF_SONGS, EnumBible.fromName("Song of Songs"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(SONG_OF_SONGS, EnumBible.fromString("Song of Songs"));
	}
	
	@Test
	public void testFromAliasSongofSolomon(){
		assertEquals(SONG_OF_SONGS, EnumBible.fromString("Song of Solomon"));
	}
	
	@Test
	public void testFromAliasSong(){
		assertEquals(SONG_OF_SONGS, EnumBible.fromString("Song"));
	}
	
	@Test
	public void testFromAliasSo(){
		assertEquals(SONG_OF_SONGS, EnumBible.fromString("So"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(SONG_OF_SONGS, EnumBible.fromInt(22));
	}
}
