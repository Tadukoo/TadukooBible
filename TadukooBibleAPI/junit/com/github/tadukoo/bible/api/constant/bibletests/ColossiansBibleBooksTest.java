...
import static com.github.tadukoo.bible.api.constant.BibleBooks.COLOSSIANS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class ColossiansBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(COLOSSIANS, BibleBooks.fromName("Colossians"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(COLOSSIANS, BibleBooks.fromString("Colossians"));
	}
	
	@Test
	public void testFromAliasCol(){
		assertEquals(COLOSSIANS, BibleBooks.fromString("Col"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(COLOSSIANS, BibleBooks.fromInt(51));
	}
}
