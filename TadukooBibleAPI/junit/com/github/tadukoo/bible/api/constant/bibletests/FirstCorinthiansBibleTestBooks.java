...
import static com.github.tadukoo.bible.api.constant.BibleBooks.FIRST_CORINTHIANS;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class FirstCorinthiansBibleTestBooks{
	...
	public void testFromName(){
		assertEquals(FIRST_CORINTHIANS, BibleBooks.fromName("1 Corinthians"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(FIRST_CORINTHIANS, BibleBooks.fromString("1 Corinthians"));
	}
	
	@Test
	public void testFromAlias1Cor(){
		assertEquals(FIRST_CORINTHIANS, BibleBooks.fromString("1Cor"));
	}
	
	@Test
	public void testFromAlias1Co(){
		assertEquals(FIRST_CORINTHIANS, BibleBooks.fromString("1Co"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(FIRST_CORINTHIANS, BibleBooks.fromInt(46));
	}
}
