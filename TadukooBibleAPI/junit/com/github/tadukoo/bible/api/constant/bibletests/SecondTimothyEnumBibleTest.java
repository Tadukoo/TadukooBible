...
import static com.github.tadukoo.bible.api.constant.EnumBible.SECOND_TIMOTHY;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class SecondTimothyEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(SECOND_TIMOTHY, EnumBible.fromName("2 Timothy"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(SECOND_TIMOTHY, EnumBible.fromString("2 Timothy"));
	}
	
	@Test
	public void testFromAlias2Tim(){
		assertEquals(SECOND_TIMOTHY, EnumBible.fromString("2Tim"));
	}
	
	@Test
	public void testFromAlias2Ti(){
		assertEquals(SECOND_TIMOTHY, EnumBible.fromString("2Ti"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(SECOND_TIMOTHY, EnumBible.fromInt(55));
	}
}
