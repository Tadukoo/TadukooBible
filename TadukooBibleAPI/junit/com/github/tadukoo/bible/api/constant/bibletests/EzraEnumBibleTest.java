...
import static com.github.tadukoo.bible.api.constant.EnumBible.EZRA;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class EzraEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(EZRA, EnumBible.fromName("Ezra"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(EZRA, EnumBible.fromString("Ezra"));
	}
	
	@Test
	public void testFromAliasEzr(){
		assertEquals(EZRA, EnumBible.fromString("Ezr"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(EZRA, EnumBible.fromInt(15));
	}
}
