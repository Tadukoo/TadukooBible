...
import static com.github.tadukoo.bible.api.constant.BibleBooks.DEUTERONOMY;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class DeuteronomyBibleBooksTest{
	...
	public void testFromName(){
		assertEquals(DEUTERONOMY, BibleBooks.fromName("Deuteronomy"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(DEUTERONOMY, BibleBooks.fromString("Deuteronomy"));
	}
	
	@Test
	public void testFromAliasDeu(){
		assertEquals(DEUTERONOMY, BibleBooks.fromString("Deu"));
	}
	
	@Test
	public void testFromAliasDe(){
		assertEquals(DEUTERONOMY, BibleBooks.fromString("De"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(DEUTERONOMY, BibleBooks.fromInt(5));
	}
}
