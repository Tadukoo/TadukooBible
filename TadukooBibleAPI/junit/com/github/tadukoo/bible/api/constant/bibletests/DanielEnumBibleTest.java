...
import static com.github.tadukoo.bible.api.constant.EnumBible.DANIEL;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class DanielEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(DANIEL, EnumBible.fromName("Daniel"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(DANIEL, EnumBible.fromString("Daniel"));
	}
	
	@Test
	public void testFromAliasDan(){
		assertEquals(DANIEL, EnumBible.fromString("Dan"));
	}
	
	@Test
	public void testFromAliasDa(){
		assertEquals(DANIEL, EnumBible.fromString("Da"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(DANIEL, EnumBible.fromInt(27));
	}
}
