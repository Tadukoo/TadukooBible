...
public class FirstPeterEnumBibleTest{
	...
	public void testFromName(){
		assertEquals(FIRST_PETER, EnumBible.fromName("1 Peter"));
	}
	
	@Test
	public void testFromStringName(){
		assertEquals(FIRST_PETER, EnumBible.fromString("1 Peter"));
	}
	
	@Test
	public void testFromAlias1Pe(){
		assertEquals(FIRST_PETER, EnumBible.fromString("1Pe"));
	}
	
	@Test
	public void testFromInt(){
		assertEquals(FIRST_PETER, EnumBible.fromInt(60));
	}
}
