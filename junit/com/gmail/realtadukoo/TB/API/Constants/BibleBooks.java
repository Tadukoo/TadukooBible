package com.gmail.realtadukoo.TB.API.Constants;

public final class BibleBooks extends CommonBookStrings{
	private BibleBooks(){ }
	...
	public static final String FIRST_SAMUEL = FIRST + " " + SAMUEL;
	public static final String SECOND_SAMUEL = SECOND + " " + SAMUEL;
	
	private static final String KINGS = "Kings";
	public static final String FIRST_KINGS = FIRST + " " + KINGS;
	public static final String SECOND_KINGS = SECOND + " " + KINGS;
	
	private static final String CHRONICLES = "Chronicles";
	public static final String FIRST_CHRONICLES = FIRST + " " + CHRONICLES;
	public static final String SECOND_CHRONICLES = SECOND + " " + CHRONICLES;
	
	public static final String EZRA = "Ezra";
	public static final String NEHEMIAH = "Nehemiah";
	public static final String ESTHER = CommonBookStrings.ESTHER;
	...
	public static final String SONG_OF_SONGS = "Song of Songs";
	public static final String ISAIAH = "Isaiah";
	public static final String JEREMIAH = CommonBookStrings.JEREMIAH;
	...
	public static final String HABAKKUK = "Habakkuk";
	...
	public static final String FIRST_CORINTHIANS = FIRST + " " + CORINTHIANS;
	public static final String SECOND_CORINTHIANS = SECOND + " " + CORINTHIANS;
	
	public static final String GALATIANS = "Galatians";
	...
	private static final String THESSALONIANS = "Thessalonians";
	public static final String FIRST_THESSALONIANS = FIRST + " " + THESSALONIANS;
	public static final String SECOND_THESSALONIANS = SECOND + " " + THESSALONIANS;
	
	private static final String TIMOTHY = "Timothy";
	public static final String FIRST_TIMOTHY = FIRST + " " + TIMOTHY;
	public static final String SECOND_TIMOTHY = SECOND + " " + TIMOTHY;
	...
	public static final String FIRST_PETER = FIRST + " " + PETER;
	public static final String SECOND_PETER = SECOND + " " + PETER;
	
	public static final String FIRST_JOHN = FIRST + " " + JOHN;
	public static final String SECOND_JOHN = SECOND + " " + JOHN;
	public static final String THIRD_JOHN = THIRD + " " + JOHN;
